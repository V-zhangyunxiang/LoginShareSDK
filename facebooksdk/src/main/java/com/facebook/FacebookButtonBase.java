...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(
        ...
        defStyleRes = (defStyleRes == 0 ? com.cmplay.util.GameResId.getStyleResIDByName(context, "com_facebook_button") : defStyleRes);
    ...
    private void parseBackgroundAttributes(
        ...
        try {
            if (a.hasValue(0)) {
                ...
                setBackgroundColor(ContextCompat.getColor(context, com.cmplay.util.GameResId.getColorResIDByName(context, "com_facebook_blue")));
            }
        } finally {
            a.recycle();
        }
