...
public class FacebookActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(GameResId.getLayoutResIDByName(this, "com_facebook_activity_layout"));
        ...
        if (fragment == null) {
            if (FacebookDialogFragment.TAG.equals(intent.getAction())) {
                ...
                manager.beginTransaction()
                        .add(GameResId.getIdResIDByName(this, "com_facebook_fragment_container"), fragment, FRAGMENT_TAG)
                        .commit();
            }
        }
