...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initialize(Context context) {
        ...
        caretHeight = getResources().getDimension(GameResId.getDimenResIDByName(context, "com_facebook_likeboxcountview_caret_height"));
        caretWidth = getResources().getDimension(GameResId.getDimenResIDByName(context, "com_facebook_likeboxcountview_caret_width"));
        borderRadius = getResources().getDimension(GameResId.getDimenResIDByName(context, "com_facebook_likeboxcountview_border_radius"));

        borderPaint = new Paint();
        borderPaint.setColor(
                getResources().getColor(GameResId.getColorResIDByName(context, "com_facebook_likeboxcountview_border_color")));
        borderPaint.setStrokeWidth(getResources().getDimension(GameResId.getDimenResIDByName(context, "com_facebook_likeboxcountview_border_width")));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        likeCountLabel.setTextSize(
                ...
                getResources().getDimension(GameResId.getDimenResIDByName(context, "com_facebook_likeboxcountview_text_size")));
        likeCountLabel.setTextColor(
                getResources().getColor(GameResId.getColorResIDByName(context, "com_facebook_likeboxcountview_text_color")));
        textPadding = getResources().getDimensionPixelSize(GameResId.getDimenResIDByName(context, "com_facebook_likeboxcountview_text_padding"));

        // Calculate the additional text padding that will be applied in the direction of the caret.
        additionalTextPadding = getResources().getDimensionPixelSize(GameResId.getDimenResIDByName(context, "com_facebook_likeboxcountview_caret_height"));
    }
