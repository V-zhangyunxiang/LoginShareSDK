...
public class LikeView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(
                attrs, GameResId.getItemIdArray("com.facebook", "styleable", "com_facebook_like_view"));
        if (a == null) {
            return;
        }

        objectId = Utility.coerceValueIfNullOrEmpty(
                a.getString(GameResId.getResFieldValue("com.facebook", "styleable", "com_facebook_like_view_com_facebook_object_id")), null);
        objectType = ObjectType.fromInt(
                a.getInt(GameResId.getResFieldValue("com.facebook", "styleable", "com_facebook_like_view_com_facebook_object_type"),
                        ObjectType.DEFAULT.getValue()));
        likeViewStyle = Style.fromInt(
                a.getInt(GameResId.getResFieldValue("com.facebook", "styleable", "com_facebook_like_view_com_facebook_style"),
        ...
        auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(
                a.getInt(GameResId.getResFieldValue("com.facebook", "styleable", "com_facebook_like_view_com_facebook_auxiliary_view_position"),
        ...
        horizontalAlignment = HorizontalAlignment.fromInt(
                a.getInt(GameResId.getResFieldValue("com.facebook", "styleable", "com_facebook_like_view_com_facebook_horizontal_alignment"),
        ...
        foregroundColor = a.getColor(
                GameResId.getResFieldValue("com.facebook", "styleable", "com_facebook_like_view_com_facebook_foreground_color"), NO_FOREGROUND_COLOR);
    ...
    private void initialize(Context context) {
        edgePadding = getResources().getDimensionPixelSize(GameResId.getDimenResIDByName(context, "com_facebook_likeview_edge_padding"));
        internalPadding = getResources().getDimensionPixelSize(GameResId.getDimenResIDByName(context, "com_facebook_likeview_internal_padding"));
        if (foregroundColor == NO_FOREGROUND_COLOR) {
            foregroundColor = getResources().getColor(GameResId.getColorResIDByName(context, "com_facebook_likeview_text_color"));
        }
    ...
    private void initializeSocialSentenceView(Context context) {
        ...
        socialSentenceView.setTextSize(
                ...
                getResources().getDimension(GameResId.getDimenResIDByName(context, "com_facebook_likeview_text_size")));
