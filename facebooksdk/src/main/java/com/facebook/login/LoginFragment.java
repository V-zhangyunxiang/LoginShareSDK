...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View view = inflater.inflate(GameResId.getLayoutResIDByName(getContext(), "com_facebook_login_fragment"), container, false);

        loginClient.setBackgroundProcessingListener(
                new LoginClient.BackgroundProcessingListener() {
                    @Override
                    public void onBackgroundProcessingStarted() {
                        view.findViewById(GameResId.getIdResIDByName(getContext(), "com_facebook_login_activity_progress_bar"))
    ...
    public void onPause() {
        ...
        getActivity().findViewById(GameResId.getIdResIDByName(getContext(), "com_facebook_login_activity_progress_bar")).setVisibility(
                View.GONE);
    }
