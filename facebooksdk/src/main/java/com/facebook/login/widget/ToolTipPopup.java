...
public class ToolTipPopup {
    ...
    public void show() {
        if (mAnchorViewRef.get() != null) {
            ...
            TextView body = (TextView) mPopupContent.findViewById(
                    GameResId.getIdResIDByName(mContext, "com_facebook_tooltip_bubble_view_text_body"));
            body.setText(mText);
            if (mStyle == Style.BLUE) {
                mPopupContent.bodyFrame.setBackgroundResource(
                        GameResId.getDrawableResIDByName(mContext, "com_facebook_tooltip_blue_background"));
                mPopupContent.bottomArrow.setImageResource(
                        GameResId.getDrawableResIDByName(mContext, "com_facebook_tooltip_blue_bottomnub"));
                mPopupContent.topArrow.setImageResource(
                        GameResId.getDrawableResIDByName(mContext, "com_facebook_tooltip_blue_topnub"));
                mPopupContent.xOut.setImageResource(GameResId.getDrawableResIDByName(mContext, "com_facebook_tooltip_blue_xout"));
            } else {
                mPopupContent.bodyFrame.setBackgroundResource(
                        GameResId.getDrawableResIDByName(mContext, "com_facebook_tooltip_black_background"));
                mPopupContent.bottomArrow.setImageResource(
                        GameResId.getDrawableResIDByName(mContext, "com_facebook_tooltip_black_bottomnub"));
                mPopupContent.topArrow.setImageResource(
                        GameResId.getDrawableResIDByName(mContext, "com_facebook_tooltip_black_topnub"));
                mPopupContent.xOut.setImageResource(GameResId.getDrawableResIDByName(mContext, "com_facebook_tooltip_black_xout"));
            }
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            ...
            inflater.inflate(GameResId.getLayoutResIDByName(getContext(), "com_facebook_tooltip_bubble"), this);
            topArrow = (ImageView) findViewById(GameResId.getIdResIDByName(getContext(), "com_facebook_tooltip_bubble_view_top_pointer"));
            bottomArrow = (ImageView) findViewById(
                    GameResId.getIdResIDByName(getContext(), "com_facebook_tooltip_bubble_view_bottom_pointer"));
            bodyFrame = findViewById(GameResId.getIdResIDByName(getContext(), "com_facebook_body_frame"));
            xOut = (ImageView) findViewById(GameResId.getIdResIDByName(getContext(), "com_facebook_button_xout"));
        }
