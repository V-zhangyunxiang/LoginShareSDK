...
public class LoginButton extends FacebookButtonBase {
        ...
        switch (toolTipMode) {
            ...
            case DISPLAY_ALWAYS:
                String toolTipString = getResources().getString(
                        GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_tooltip_default"));
                displayToolTip(toolTipString);
                break;
            case NEVER_DISPLAY:
                break;
    ...
    protected void configureButton(
        ...
        if (isInEditMode()) {
            ...
            setBackgroundColor(getResources().getColor(  GameResId.getColorResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_blue")));
    ...
    protected int getDefaultStyleResource() {
        return GameResId.getStyleResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_default_style");
    }
    ...
    private void parseLoginButtonAttributes(
        ...
        final TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                GameResId.getItemIdArray(context,"styleable", "com_facebook_login_view"),
                defStyleAttr,
                defStyleRes);
        try {
            confirmLogout = a.getBoolean(GameResId.getItemId(getContext(), "styleable", "com_facebook_login_view_com_facebook_confirm_logout")
                    , true);
            loginText = a.getString(GameResId.getItemId(getContext(),"styleable", "com_facebook_login_view_com_facebook_login_text"));
            logoutText = a.getString(GameResId.getItemId(getContext(),"styleable", "com_facebook_login_view_com_facebook_logout_text"));
            toolTipMode = ToolTipMode.fromInt(a.getInt(
                    GameResId.getItemId(getContext(),"styleable", "com_facebook_login_view_com_facebook_tooltip_mode"),
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width;
        if (text == null) {
            text = resources.getString(GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_log_in_button_long"));
            logInWidth = measureButtonWidth(text);
            width = resolveSize(logInWidth, widthMeasureSpec);
            if (width < logInWidth) {
                text = resources.getString(GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_log_in_button"));
            }
        }
        logInWidth = measureButtonWidth(text);
        ...
        text = logoutText;
        if (text == null) {
            text = resources.getString(GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_log_out_button"));
        }
    ...
    private void setButtonText() {
        ...
        if (!isInEditMode() && AccessToken.getCurrentAccessToken() != null) {
            setText((logoutText != null) ?
                    logoutText :
                    resources.getString(GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_log_out_button")));
        } else {
            if (loginText != null) {
                setText(loginText);
            } else {
                String text = resources.getString(
                        GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_log_in_button_long"));
                int width = getWidth();
            ...
            if (accessToken != null) {
                ...
                if (confirmLogout) {
                    ...
                    String logout = getResources().getString(
                            GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_log_out_action"));
                    String cancel = getResources().getString(
                            GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_cancel_action"));
                    String message;
                    Profile profile = Profile.getCurrentProfile();
                    if (profile != null && profile.getName() != null) {
                        message = String.format(
                                getResources().getString(
                                        GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_logged_in_as")),
                                profile.getName());
                    } else {
                        message = getResources().getString(
                                GameResId.getStringResIDByName(FacebookSdk.getApplicationContext(), "com_facebook_loginview_logged_in_using_facebook"));
                    }
