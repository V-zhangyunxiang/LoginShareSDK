...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(
                attrs, GameResId.getItemIdArray(getContext(), "styleable", "com_facebook_profile_picture_view"));
        setPresetSize(a.getInt(GameResId.getItemId(getContext(),"styleable", "com_facebook_profile_picture_view_com_facebook_preset_size"), CUSTOM));
        isCropped = a.getBoolean(
                GameResId.getItemId(getContext(),"styleable", "com_facebook_profile_picture_view_com_facebook_is_cropped"), IS_CROPPED_DEFAULT_VALUE);
        a.recycle();
    }
    ...
    private void setBlankProfilePicture() {
        ...
        if (customizedDefaultProfilePicture == null) {
            int blankImageResource = isCropped() ?
                    GameResId.getDrawableResIDByName(getContext(), "com_facebook_profile_picture_blank_square") :
                    GameResId.getDrawableResIDByName(getContext(), "com_facebook_profile_picture_blank_portrait");
    ...
    private int getPresetSizeInPixels(boolean forcePreset) {
        ...
        switch (presetSizeType) {
            case SMALL:
                dimensionId = GameResId.getDimenResIDByName(getContext(), "com_facebook_profilepictureview_preset_size_small");
                break;
            case NORMAL:
                dimensionId = GameResId.getDimenResIDByName(getContext(), "com_facebook_profilepictureview_preset_size_normal");
                break;
            case LARGE:
                dimensionId = GameResId.getDimenResIDByName(getContext(), "com_facebook_profilepictureview_preset_size_large");
                break;
            case CUSTOM:
                if (!forcePreset) {
